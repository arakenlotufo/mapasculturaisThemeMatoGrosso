...
<?php if ( $this->isEditable() || (($has_private_location && $entity->publicLocation && $lat && $lng) || (!$has_private_location && $lat && $lng)) ): ?>
    ...
    <div class="servico clearfix">
        ...
        <div class="infos">
            ...
            <p><span class="label">Logradouro:</span> <span class="js-editable" id="En_Nome_Logradouro" data-edit="En_Nome_Logradouro" data-original-title="Logradouro Insira o CEP " data-emptytext="Insira o logradouro" data-showButtons="bottom"><?php echo $entity->En_Nome_Logradouro ?></span></p>
            <p><span class="label">Número:</span> <span class="js-editable" id="En_Num" data-edit="En_Num" data-original-title="Número" data-emptytext="Insira o Número Insira o CEP " data-showButtons="bottom"><?php echo $entity->En_Num ?></span></p>
            ...
            <p><span class="label">Bairro:</span> <span class="js-editable" id="En_Bairro" data-edit="En_Bairro" data-original-title="Bairro" data-emptytext="Insira o Bairro Insira o CEP " data-showButtons="bottom"><?php echo $entity->En_Bairro ?></span></p>
            <p><span class="label">Município:</span> <span class="js-editable" id="En_Municipio" data-edit="En_Municipio" data-original-title="Município" data-emptytext="Insira o Município Insira o CEP " data-showButtons="bottom"><?php echo $entity->En_Municipio ?></span></p>
            <p><span class="label">Estado:</span> <span class="js-editable" id="En_Estado" data-edit="En_Estado" data-original-title="Estado" data-emptytext="Insira o Estado Insira o CEP " data-showButtons="bottom"><?php echo $entity->En_Estado ?></span></p>
