...
//                'v::regex("#^(\d{2}(\.\d{3}){2}/\d{4}-\d{2})|(\d{3}\.\d{3}\.\d{3}-\d{2})$#")' => 'Utilize o formato xxx.xxx.xxx-xx para CPF e xx.xxx.xxx/xxxx-xx para CNPJ.'
        ...
        'raca' => array(
	        ...
	        'validations' => array(
                'required' => 'Informe raça/cor, ele é obrigatório.',
	           )
        ),
        ...
        'dataDeNascimento' => array(
            ...
            'type' => 'date',
            'validations' => array(
               'required' => 'Informe a data, ela é obrigatório.', 
        ...
        'genero' => array(
            ...
            'label' => 'Gênero',
            'type' => 'select',
            'required' => 'Informe o Gênero, ele é obrigatório.',
            'options' => array(
                'Não Informar' => 'Não Informar',
        ...
        'telefone1' => array(
            ...
            'type' => 'string',
            'validations' => array(
                         'required' => 'O telefone1 privado é obrigatório.',
