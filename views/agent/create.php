        ...
        <div id="sobre" class="aba-content">
            ...
            <div class="ficha-spcultura">
                ...
                <div class="servico">
                    ...
                    <?php if($this->isEditable()): ?>
                    <p class="privado"><span class="icon icon-private-info"></span><span class="label">Telefone 1:</span> <span class="js-editable js-mask-phone" data-edit="telefone1" data-original-title="Telefone Privado" data-emptytext="Insira um telefone que não será exibido publicamente (obrigatorio) pode ser o mesmo número do telefone públio"><?php echo $entity->telefone1; ?></span></p>
